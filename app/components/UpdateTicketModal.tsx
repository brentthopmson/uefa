    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
          <h2 className="text-2xl font-black text-[#1f262d]">Update Ticket</h2>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-gray-700 dark:text-gray-300 mb-1">Gate</label>
              <input
                type="text"
                name="gate"
                value={formData.gate || ''}
            ...
            <div>
              <label className="block text-gray-700 dark:text-gray-300 mb-1">Entrance</label>
              <input
                type="text"
                name="entrance"
            ...
            <div>
              <label className="block text-gray-700 dark:text-gray-300 mb-1">Hospitality Area</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-700 dark:text-gray-300 mb-1">Ticket Holder</label>
              <input
                type="text"
                name="ticketHolder"
